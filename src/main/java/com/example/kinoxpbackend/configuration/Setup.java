...
public class Setup implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        // add screenings
        Screening screening = new Screening(0.0,0.0, LocalDateTime.of(2022, 10, 10, 20, 25), LocalDateTime.of(2022, 10, 10, 23, 55), movie2, theater);
        Screening screening2 = new Screening(0.0,0.0, LocalDateTime.of(2022, 10, 11, 20, 20), LocalDateTime.of(2022, 11, 11, 23, 10), movie, theater2);
        Screening screening3 = new Screening(0.0,0.0, LocalDateTime.of(2022, 10, 12, 20, 15), LocalDateTime.of(2022, 12, 11, 23, 1), movie2, theater);
