...
public class Setup implements ApplicationRunner {
  ...
  public Setup(MovieRepository movieRepository,
    ...
    public void run (ApplicationArguments args) throws Exception {
      ...
      // Add movie
      Movie movie = new Movie("Batman Begins", "Good movie", 5, "Action", "2h 20min", "PG-15", 100, LocalDate.of(2022, 10, 10), LocalDate.of(2022, 12, 26));
      Movie movie2 = new Movie("Batman Dark knight", "Best movie", 5, "Action", "2h 12min", "PG-13", 100, LocalDate.of(2022, 10, 10), LocalDate.of(2022, 12, 26));
      Movie movie3 = new Movie("Batman Rises", "Decent movie", 5, "Action", "2h 11min", "PG", 100, LocalDate.of(2022, 10, 10), LocalDate.of(2022, 12, 26));
      Movie movie4 = new Movie("The Batman", "Weird movie", 5, "Action", "2h 54min", "PG-15", 100, LocalDate.of(2022, 10, 10), LocalDate.of(2022, 12, 26));
